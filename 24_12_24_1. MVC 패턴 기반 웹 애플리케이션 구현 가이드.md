...
├── com.gamebox
│   ├── controller
│   │   └── FrontController.java           # 모든 요청을 처리하는 컨트롤러
│   ├── action
│   │   ├── LoginAction.java               # 로그인 로직 처리
│   │   ├── RegisterAction.java            # 회원가입 로직 처리
│   │   ├── LogoutAction.java              # 로그아웃 처리
...
│   │   └── ReviewsDTO.java                # 리뷰 데이터 객체
│   └── util
│       └── DBConnectionUtil.java          # DB 연결 클래스 (Singleton)
...
│   │   │   ├── games.jsp                  # 게임 목록 페이지
│   │   │   ├── library.jsp                # 개인 라이브러리 페이지
│   │   │   └── community.jsp              # 커뮤니티 페이지
│   │   ├── admin
│   │   │   ├── a_dashboard.jsp            # 관리자 대시보드
│   │   │   ├── a_users.jsp                # 회원 관리 페이지
│   │   │   ├── a_games.jsp                # 게임 관리 페이지
│   │   │   ├── a_reviews.jsp              # 리뷰 관리 페이지
│   │   │   └── a_payments.jsp             # 결제 관리 페이지
│   └── web.xml                            # 프로젝트 설정 파일
├── resources
│   ├── css
│   │   ├── style.css                      # 기본 스타일
│   │   ├── header_style.css               # 헤더 스타일
│   │   └── footer_style.css               # 푸터 스타일
│   ├── js
